...
abstract class AcquiringRequest<R : AcquiringResponse>(internal val apiMethod: String) :
    ...
    protected fun performRequestRaw(request: AcquiringRequest<R>): Response {
        request.validate()
    ...
    protected fun performRequestFlow(responseClass: Class<R>) : Flow<RequestResult<out R>> {
...
suspend inline fun <R : AcquiringResponse> Request<R>.performSuspendRequest(): Result<R> {
