...
class FinishAuthorizeRequest : AcquiringRequest<FinishAuthorizeResponse>(FINISH_AUTHORIZE_METHOD),
    PaymentAdditionalDataParamsDelegate by PaymentAdditionalDataParamsImpl()
{
    ...
    private fun fillPaymentData() {
        ...
        when (paymentSource) {
            ...
            else -> throw AcquiringSdkException(IllegalStateException("Unknown type in 'paymentSource'"), paymentId = paymentId)
        }
    }
