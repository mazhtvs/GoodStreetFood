...
public class ZakazNalActivity extends AppCompatActivity {
    TextView textView25;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zakaznal);
        ...
        textView25.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ZakazNalActivity.this, MainActivity.class);
    ...
    private void sendOrderConfirmationEmail() {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                if (isProfileDataComplete(ZakazNalActivity.this)) {
                    ...
                    emailBodyBuilder.append("Должен оплатить наличными\n");
