...
internal open class TransparentActivity : BaseAcquiringActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        supportFragmentManager.findFragmentById(R.id.acq_activity_fl_container)
    ...
    override fun initViews(fullScreenMode: Boolean) {
        super.initViews(fullScreenMode)
        ...
        if (viewType == FULL_SCREEN_INDEX || fullScreenMode) {
