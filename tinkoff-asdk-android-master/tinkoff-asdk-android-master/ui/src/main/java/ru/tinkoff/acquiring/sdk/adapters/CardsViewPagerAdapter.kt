        ...
        when (viewTypeList[position]) {
            PageViewType.ENTER_CARD -> {
                editCard.run {
                    ...
                    cardNumberHint = context.getString(ASDKString.acq_pay_card_pan_hint)
                    cardDateHint = context.getString(ASDKString.acq_pay_card_expire_date_hint)
                    cardCvcHint = context.getString(ASDKString.acq_pay_card_cvc_hint)
                }
