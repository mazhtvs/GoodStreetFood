...
internal class TpayViewModel(
    ...
    val state: Flow<PaymentStatusSheetState> = tpayProcess.state.mapNotNull(tpayProcessMapper::mapState)
    val navEvent: Flow<TpayNavigation.Event> = tpayNavigation.flow
