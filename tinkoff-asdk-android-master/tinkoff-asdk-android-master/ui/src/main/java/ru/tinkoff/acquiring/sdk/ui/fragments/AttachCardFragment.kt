...
internal class AttachCardFragment : BaseAcquiringFragment(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireActivity().intent.extras?.let { extras ->
            ...
            cardDataInput.useSecureKeyboard = attachCardOptions.features.useSecureKeyboard
            cardDataInput.onNext = {
                if (it == cardDataInput.cvcInput) {
                    cardDataInput.cvcInput.hideKeyboard()
                    true
                } else false
            }
        }
