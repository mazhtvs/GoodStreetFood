...
internal fun View.setupCvcInput(viewGroup: ViewGroup, cardPayComponent: CardPayComponent) {
    val inputField = viewGroup.findViewById<AcqTextFieldView>(R.id.cvc_input)
    val inputEditText = inputField.editText
...
internal fun View.requestCvcFocus(viewGroup: ViewGroup, cardPayComponent: CardPayComponent) {
    val inputField = viewGroup.findViewById<AcqTextFieldView>(R.id.cvc_input)
    val inputEditText = inputField.editText
