 ...
 */
fun MainPaymentFormViewModelFactory(application: Application, paymentOptions: PaymentOptions) =
    viewModelFactory {
        ...
        initializer {
            ...
            val nspkChecker = NspkInstalledAppsCheckerImpl(application.packageManager)
