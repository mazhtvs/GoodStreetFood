...
open class AcqTextFieldView @JvmOverloads constructor(
        context: Context,
    ...
    var useSecureKeyboard: Boolean by editText::useSecureKeyboard
    var maxSymbols: Int
    ...
    var nextPressedListener: (() -> Boolean)? by textInputLayout::nextPressedListener
